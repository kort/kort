...
\begin{itemize}
	...
	\begin{itemize}
		\item Quellen für bekannte Fehler: \gls{OpenStreetMap} Bug Reports, \inlinecode{FIXME}- und \inlinecode{TODO}-\glspl{Tag}
...
Neben diesem Dokument umfasst die Arbeit die implementierte \gls{WebApp} \textsc{Kort}. Der dazugehörige Source Code ist frei im Internet zugänglich, sowie auf der beigelegten CD zu finden.
...
\hline 
\textsc{Kort} (\gls{WebApp}) & \url{http://kort.herokuapp.com} \\ 
\hline 

...
Dabei sind das Zielsystem (\gls{OpenStreetMap}) und die Fehlerquelle (Keepright, siehe Kapitel \ref{datenquellen}) Fremdsysteme, bei welchen die Schnittstellen gegeben waren. 
...
\section{Umsysteme}
Zu unserem System gehören auch die Fehlerdatenquelle Keepright sowie \gls{OpenStreetMap} dazu.

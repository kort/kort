...
Dabei sind das Zielsystem (\gls{OpenStreetMap}) und die Fehlerquelle (\brand{KeepRight}, siehe Kapitel \ref{datenquellen}) Fremdsysteme, bei welchen die Schnittstellen gegeben waren. 
...
\section{Umsysteme}
Zu unserem System gehören auch die Fehlerdatenquelle \brand{KeepRight} sowie \gls{OpenStreetMap} dazu.

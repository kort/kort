...
Das Skript \inlinecode{ŕedmine_backup.sh} kümmert sich darum alle Backup-Daten täglich auf dem virtuellen Server zu sammeln und an einem zentralen Ort zu speichern.
Mit dem zweiten Skript \inlinecode{sync_backup.sh} kann dann das zuvor erstellte Backup auf beliebige andere Systeme verteilt werden.

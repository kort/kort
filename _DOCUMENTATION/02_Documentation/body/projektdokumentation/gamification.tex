...
Die Statistik der Benutzer von \brand{OpenStreetMap} bestätigt dieses Bild: fast zwei Drittel der Benutzer hat zwar ein Benutzerkonto, hat aber noch keine Änderungen vorgenommen.

...
\brand{Leaflet}\footnote{\url{http://leafletjs.com/}} wurde eingesetzt, um \gls{OpenStreetMap}-Daten auf der Karte anzuzeigen. Zusätzlich wurde das \emph{leaflet-osm}\footnote{\url{https://github.com/jfirebaugh/leaflet-osm}}-Plugin für Leaflet verwendet, um \gls{OpenStreetMap}-Objekte als \inlinecode{XML}-Code direkt auf der Karte darzustellen.
...
\label{sencha-cmd}
Das Grundgerüst der App wurde komplett mit dem Sencha-eigenen Build-Tool \brand{Sencha Cmd 3.0.0.250}\footnote{\url{http://www.sencha.com/products/sencha-cmd}} generiert.
...
Zur Erstellung eines \kort-Builds muss \brand{Sencha Cmd} in der Version 3.0.0.250 installiert sein.

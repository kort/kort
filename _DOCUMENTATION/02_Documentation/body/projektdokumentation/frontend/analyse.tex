...
Die App hat ihn bereits lokalisiert und zeigt ihm offene \gls{OpenStreetMap}-Aufträge, wahlweise als Liste oder auf der Karte, in der Nähe an.
...
Andy sitzt im Zug und langweilt sich. Er öffnet die \textsc{Kort}-App im Indoor-Modus und sieht sich die Liste der zu validieren Bugfixes an. Er sortiert die Liste um diejenigen Einträge zu sehen, welche nur noch einen Review benötigen um zu \gls{OpenStreetMap} gesendet zu werden.
...
Aus den gesetzten Projektzielen und den Anforderungen aus den erstellten Szenarien (siehe Abschnitt \ref{kort-user-szenarien}) wurde vor der Implementation der Oberfläche ein Paper-Prototype des GUI-Designs erstellt.
...
Wenn der Benutzer erfolgreich angemeldet wurde erscheint die Maske mit den Aufträgen.
...
Mit einem Klick auf Senden schliesst sich die Detailansicht und man gelangt zur Karte mit den Aufträgen zurück.

...
\begin{itemize}
\item Ein Fehler muss sich konkret auf ein \gls{OpenStreetMap}-Objekt beziehen (Node, Way oder Relation)
...
\todo[inline]{Bild kort all\_errors einfuegen}
...
\todo[inline]{Internationalisierung Fehler-Texte beschreiben}
...
\todo[inline]{Bild keepright error\_type einfügen}

...
Die Registrierung bei OpenStreetMap ist sehr ähnlich wie bei Google.
Leider bietet aber OSM keine Möglichkeit an, bei einer Registrierung mehrere URLs anzugeben.
...
Damit kann er theoretisch die Daten welche von und zu der Applikation geschickt werden abfangen und ändern.

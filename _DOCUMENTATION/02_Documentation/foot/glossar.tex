...
\newglossaryentry{Node} {
	name = Node,
	description = {Ein Node ist das grundlegenste Objekt in OpenStreetMap, es wird durch seine Attribute (genannt \glspl{Tags}) genauer bestimmt. Nodes können Teil eines \gls{Way} sein.}
}

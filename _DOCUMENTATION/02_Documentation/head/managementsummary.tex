...
Einige Tools wie \emph{KeepRight}\footnote{\url{http://keepright.ipax.at/}} oder \emph{Osmose}\footnote{\url{http://osmose.openstreetmap.fr/map/}} (Abbildung \ref{image-osmose-screenshot}) berechnen aus den Karten-Rohdaten die vorhanden Fehler.
...
Quellen für derartige Fehler sind beispielsweise \emph{OpenStreetBugs}\footnote{\url{http://openstreetbugs.schokokeks.org/}} oder die \inlinecode{FIXME}-\glspl{Tag} aus \emph{KeepRight}.

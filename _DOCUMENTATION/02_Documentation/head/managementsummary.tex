...
Dadurch erhält diese Aufgabe einen ganz neuen Reiz und spricht den Spieltrieb des Menschen an.
...
Ähnlich wie man es von anderen Apps wie beispielsweise Foursquare\footnote{\url{https://foursquare.com/}} oder SBB.Connect\footnote{\url{http://www.sbb.ch/fahrplan/mobile-fahrplaene/mobile-apps/sbb-connect.html}} kennt.

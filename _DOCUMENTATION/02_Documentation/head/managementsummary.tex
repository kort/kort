...
Mögliche Dienste wären dabei Facebook, Twitter oder \gls{OpenStreetMap} selbst, welche alle \gls{OAuth}-Dienste anbieten.
...
\todo[inline]{Ziel "Daten zu OSM senden" nicht erreicht}
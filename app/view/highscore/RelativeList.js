/**
 * Relative Highscore list.
 */
Ext.define('Kort.view.highscore.RelativeList', {
	extend: 'Ext.List',
	alias: 'widget.highscorerelativelist',
    requires: [
        'Kort.plugin.ListTwoWayPaging'
    ],
    
	config: {
        title: Ext.i18n.Bundle.message('highscore.relative.tabtitle'),
        id: 'highScoreRelativeList',
		layout: 'fit',
		store: 'HighscoreRelative',
        loadingText: false,
        ...
        plugins: [
            {
                ...
                bidirectional: true,
                useUserPositionAsStartingPage: true
            }
        ]
	}
});
(function () {
    ...
    Ext.define("Particles.view.Particles", {
        ...
        initialize: function () {
            ...
            setInterval(function () {
                if (Ext.draw.fx.Frame.framerate) {
                    me.fps.setHtml(Ext.draw.fx.Frame.framerate.toFixed(2) + 'fps with ' + me.emitter.instances.length + ' sprites');
                }
                Ext.draw.fx.Frame.clearCounter();
            }, 1000);
            // </debug>
        },

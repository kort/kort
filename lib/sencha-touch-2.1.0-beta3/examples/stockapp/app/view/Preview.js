...
//            }
    ...
    initialize: function () {
        ...
        this.rangeMask.fx.setSpecialDuration({'handlerOpacity': 100});
        this.dragStatus = {};
    ...
    onTouchStart: function (e) {
        ...
        if (any) {
            this.rangeMask.fx.setSpecialDuration({'handlerOpacity': 0});
    ...
    onTouchEnd: function (e) {
        ...
        if (!this.dragStatus.pan && !this.dragStatus.left && !this.dragStatus.right) {
            this.rangeMask.fx.setSpecialDuration({'handlerOpacity': 500});

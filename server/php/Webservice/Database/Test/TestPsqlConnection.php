...
class TestPsqlConnection extends AbstractKortUnitTestCase
{
    ...
    public function testDoUpdateQuery()
    {
        ...
        $sql = "UPDATE schema.testtable set title = $1,sorting = $2 WHERE id = 3;";
        ...
        $this->mockDb->shouldReceive('fetch_row')->andReturn($data);
        $result = $this->psql->doUpdateQuery($data, $this->table, $this->where);

...
class FixHandler extends DbProxyHandler implements IKoinCount
{
    ...
    {
        /*
        //$sql  = "select adfm.fix_koin_count + COALESCE(adfm.promo_extra_coins,0) from kort.aggregateddate_from_missions adfm ";
        $sql  = "select fix_koin_count from kort.aggregateddate_from_missions adfm ";

...
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (90, 'motorway_ref', 'Autobahn ohne Bezeichner', 'text', 'Bezeichner', 'Ist diese Bezeichnung korrekt?', 10, 5, 3);
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (100, 'religion', 'Kultstätte/Kirche ohne Religion', 'select', 'Religion', 'Ist diese Kultstätte/Kirche von dieser Religion?', 15, 5, 3);
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (110, 'poi_name', 'Objekt ohne Namen', 'text', 'Name', 'Passt der Name zum gegebenen Objekt?', 15, 5, 3);
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (180, 'relation_type', 'Beziehung ohne Typ', 'select', 'Typ', 'Ist dieser Typ korrekt?', 15, 5, 2);
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (300, 'missing_maxspeed', 'Fehlendes Tempolimit', 'number', 'Tempolimit', 'Darf man auf dieser Strasse mit dieser Geschwindigkeit fahren?', 10, 5, 3);
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (360, 'language_unknown', 'Sprache des Namens unbekannt', 'select', 'Sprache', 'Ist der Name in folgender Sprache?', 5, 5, 3);
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (390, 'missing_track_type', 'Typ des Wegs unbekannt', 'select', 'Typ', 'Ist der Weg folgendermassen beschaffen?', 5, 5, 5);
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (71, 'way_wo_tags', 'Strasse ohne Namen', 'text', 'Strassenname', 'Ist dieser Strassenname korrekt?', 15, 5, 3);

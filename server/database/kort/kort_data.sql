...
insert into kort.error_type (error_type_id, type, description, view_type, answer_placeholder, vote_question, fix_koin_count, vote_koin_count, required_votes) values (110, 'poi_name', 'Objekt ohne Namen', 'text', 'Name', 'Passt der Name zum gegebenen Objekt?', 15, 5, 3);i

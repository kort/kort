...
insert into kort.error_type (error_type_id, type, description, osm_tag, view_type, answer_placeholder, vote_question, bug_question, fix_koin_count, vote_koin_count, required_votes) values (1001, 'missing_cuisine', 'error_type.title.missing_cuisine', 'name', 'select', 'error_type.placeholder.missing_cuisine', 'vote.question.missing_cuisine', 'bug.question.cuisine_of_restaurant', 15, 5, 3);
-- Insert badge
